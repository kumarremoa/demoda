                        ...
                        <div class="span12">
                            ...
                            <table class="table table-striped table-bordered dTableR" id="dt_a">
								...
								<?php
									...
									$s_no = 1;
									foreach($static_pages as $result)
									{
										echo '<tr>
													<td>'.$s_no.'</td>
													<td>'.$result->page_name.'</td>
													<td>'.$result->page_title.'</td>													
													<td class="center">'.anchor('page/deletePage/'.$result->id.'', 'Delete', 'class="link-class"').' '.anchor('page/edit/'.$result->id.'', 'Edit', 'class="link-class"').'</td>
											</tr>';
