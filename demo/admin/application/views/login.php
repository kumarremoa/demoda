    ...
    <body class="login_page">
		...
		<div class="login_box">
			...
			<form action="<?php echo $this->config->item('base_url'); ?>login/authincate" method="post" id="login_form">
				<div class="top_b">Sign in to Zippy Admin</div>  
				...
				<div class="cnt_b">
					<div class="formRow">
						<div class="input-prepend">
							<span class="add-on"><i class="icon-user"></i></span><input type="text" id="username" name="username" placeholder="User Name" value="" />
						</div>
					</div>
					<div class="formRow">
						<div class="input-prepend">
