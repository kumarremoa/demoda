						...
						<div class="antiscroll-content">
							<div class="sidebar_inner">
								<div id="side_accordion" class="accordion">
									...
									<div class="accordion-group">
										<div class="accordion-heading">
											<a href="#collapseTwelve" data-parent="#side_accordion" data-toggle="collapse" class="accordion-toggle">
												<i class="icon-user"></i> Blogs
											</a>
										</div>
										<div class="accordion-body collapse" id="collapseTwelve">
											<div class="accordion-inner">
												<ul class="nav nav-list">
													<li><a href="javascript:void(0)" onclick="window.open('<?php echo base_url(); ?>blog/add','_top');">Add Blog</a></li>
													<li><a href="javascript:void(0)" onclick="window.open('<?php echo base_url(); ?>blog/index','_top');">List Blogs</a></li>
												</ul>
